...
const getStatus = (completedChapters, thresholds) => {
...
const createCandidateMap = (data) => {
    ...
    data.forEach(row => {
        ...
        if (emailKey && !map.has(emailKey))
            map.set(emailKey, row);
    });
    return map;
};
export const mergeAndProcessData = (sheet1Data, // Chapter Completion
sheet2Data, // Monthly Assessment
sheet3Data, // OCS Attendance
thresholds) => {
